...
from extra_apps.my_xadmin_view import TicketAdminView, TicketControlView
...
class GrabAdmin(object):
    list_display = ['name', 'stu_id', 'major', 'is_success', 'is_checked', 'times', 'preach_people', 'ticket_id']
